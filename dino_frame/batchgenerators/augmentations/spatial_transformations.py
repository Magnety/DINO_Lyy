...
import numpy as np
from dino_frame.batchgenerators.augmentations.utils import create_zero_centered_coordinate_mesh, elastic_deform_coordinates, \
    interpolate_img, \
    rotate_coords_2d, rotate_coords_3d, scale_coords, resize_segmentation, resize_multichannel_image, \
    elastic_deform_coordinates_2
from dino_frame.batchgenerators.augmentations.crop_and_pad_augmentations import random_crop as random_crop_aug
from dino_frame.batchgenerators.augmentations.crop_and_pad_augmentations import center_crop as center_crop_aug
...
def augment_channel_translation(data, const_channel=0, max_shifts=None):
    ...
    return data_return
def dino_augment_spatial(data, seg, patch_size, patch_center_dist_from_border=30,
