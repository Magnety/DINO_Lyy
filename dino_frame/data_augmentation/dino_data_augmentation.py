...
import numpy as np
from dino_frame.batchgenerators.dataloading import MultiThreadedAugmenter
from dino_frame.batchgenerators.transforms import DataChannelSelectionTransform, SegChannelSelectionTransform, SpatialTransform, \
    GammaTransform, MirrorTransform, Compose
from dino_frame.batchgenerators.transforms.utility_transforms import RemoveLabelTransform, RenameTransform, NumpyToTensor
from dino_frame.data_augmentation.custom_transforms import Convert3DTo2DTransform, Convert2DTo3DTransform, \
    MaskTransform, ConvertSegmentationToRegionsTransform
from dino_frame.data_augmentation.pyramid_augmentations import MoveSegAsOneHotToData, \
    ApplyRandomBinaryOperatorTransform, \
    RemoveRandomConnectedComponentFromOneHotEncodingTransform
from dino_frame.batchgenerators.transforms.spatial_transforms import dino_SpatialTransform
try:
    from dino_frame.batchgenerators.dataloading.nondet_multi_threaded_augmenter import NonDetMultiThreadedAugmenter
...
default_3D_augmentation_params = {
    ...
    "num_threads": 12 if 'simple_frame_n_proc_DA' not in os.environ else int(os.environ['simple_frame_n_proc_DA']),
...
def get_patch_size(final_patch_size, rot_x, rot_y, rot_z, scale_range):
    ...
    from dino_frame.batchgenerators.augmentations.utils import rotate_coords_3d, rotate_coords_2d
...
def get_default_augmentation(dataloader_train, dataloader_val, patch_size,global_patch_size,local_patch_size, params=default_3D_augmentation_params,
    ...
    tr_transforms.append(dino_SpatialTransform(
        patch_size,(32,128,128), (16,64,64),patch_center_dist_from_border=None, do_elastic_deform=params.get("do_elastic"),
    ...
    tr_transforms.append(NumpyToTensor(['data', 'target','global_data1','global_data2','local_data'], 'float'))

    tr_transforms = Compose(tr_transforms)
    # from dino_frame.batchgenerators.dataloading import SingleThreadedAugmenter
...
if __name__ == "__main__":
    from dino_frame.training.dataloading.dataset_loading import DataLoader3D, load_dataset
    from dino_frame.paths import preprocessing_output_dir
    import os
    import pickle
