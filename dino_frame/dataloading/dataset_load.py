...
def load_dataset(folder):
    ...
    for c in case_identifiers:
        ...
        with open(folder+'/'+ "%s.pkl"%c, 'rb') as f:
...
class DataLoader3D(SlimDataLoaderBase):
    def __init__(self, data, patch_size, final_patch_size, batch_size, has_prev_stage=False,
                 ...
                 pad_sides=None,fc_path='G:/simple_frame_data_raw_base/simple_frame_raw_data/Task100_Breast_c_f_noclsmask',local_crop_num=8):
        """
    ...
    def generate_train_batch(self):
        ...
        feature = []
        case_properties = []
        #class_name = pd.read_excel('/home/ubuntu/zhangyongtao/DINO_trans/class_label.xlsx',dtype=object, keep_default_na=False, na_values=[]).values
        #print("////////////////////selected_keys//////////////////")
        #print(selected_keys)
        ...
        return {'data':data, 'global_data1':global_data1,'global_data2':global_data2,'local_data':local_data,'seg':seg, 'class_label':class_label,'properties':case_properties, 'keys': selected_keys}
