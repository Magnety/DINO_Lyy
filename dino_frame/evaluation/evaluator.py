...
from dino_frame.evaluation.metrics import ConfusionMatrix, ALL_METRICS
...
def evaluate_folder(folder_with_gts: str, folder_with_predictions: str, labels: tuple, **metric_kwargs):
    ...
    test_ref_pairs = [(folder_with_predictions+"/"+ i, folder_with_gts+"/"+i) for i in files_pred]
...
def simple_frame_evaluate_folder():
    import argparse
