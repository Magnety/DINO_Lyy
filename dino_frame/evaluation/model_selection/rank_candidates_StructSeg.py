...
from dino_frame.paths import network_training_output_dir
...
if __name__ == "__main__":
    ...
    overwrite_plans = {
        'simple_frameTrainerV2_2': ["simple_framePlans", "simple_framePlans_customClip"], # r
        'simple_frameTrainerV2_2_noMirror': ["simple_framePlans", "simple_framePlans_customClip"],  # r
        'simple_frameTrainerV2_lessMomentum_noMirror': ["simple_framePlans", "simple_framePlans_customClip"],  # r
        'simple_frameTrainerV2_2_structSeg_noMirror': ["simple_framePlans", "simple_framePlans_customClip"],  # r
        'simple_frameTrainerV2_2_structSeg': ["simple_framePlans", "simple_framePlans_customClip"],  # r
        'simple_frameTrainerV2_lessMomentum_noMirror_structSeg': ["simple_framePlans", "simple_framePlans_customClip"],  # r
        'simple_frameTrainerV2_FabiansResUNet_structSet_NoMirror_leakyDecoder': ["simple_framePlans", "simple_framePlans_customClip"],  # r
        'simple_frameTrainerV2_FabiansResUNet_structSet_NoMirror': ["simple_framePlans", "simple_framePlans_customClip"],  # r
        'simple_frameTrainerV2_FabiansResUNet_structSet': ["simple_framePlans", "simple_framePlans_customClip"],  # r

    }

    trainers = ['simple_frameTrainer'] + [
        'simple_frameTrainerV2_2',
        'simple_frameTrainerV2_lessMomentum_noMirror',
        'simple_frameTrainerV2_2_noMirror',
        'simple_frameTrainerV2_2_structSeg_noMirror',
        'simple_frameTrainerV2_2_structSeg',
        'simple_frameTrainerV2_lessMomentum_noMirror_structSeg',
        'simple_frameTrainerV2_FabiansResUNet_structSet_NoMirror_leakyDecoder',
        'simple_frameTrainerV2_FabiansResUNet_structSet_NoMirror',
        'simple_frameTrainerV2_FabiansResUNet_structSet',
    ]
