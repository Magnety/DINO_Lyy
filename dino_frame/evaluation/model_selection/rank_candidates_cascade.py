...
if __name__ == "__main__":
    ...
    output_file = network_training_output_dir+"/"+ "summary_cascade.csv"
    ...
    plans = "simple_framePlansv2.1"

    overwrite_plans = {
        'simple_frameTrainerCascadeFullRes': ['simple_framePlans'],
    }

    trainers = [
        'simple_frameTrainerCascadeFullRes',
        'simple_frameTrainerV2CascadeFullRes_EducatedGuess',
        'simple_frameTrainerV2CascadeFullRes_EducatedGuess2',
        'simple_frameTrainerV2CascadeFullRes_EducatedGuess3',
        'simple_frameTrainerV2CascadeFullRes_lowerLR',
        'simple_frameTrainerV2CascadeFullRes',
        'simple_frameTrainerV2CascadeFullRes_noConnComp',
        'simple_frameTrainerV2CascadeFullRes_shorter_lowerLR',
        'simple_frameTrainerV2CascadeFullRes_shorter',
        'simple_frameTrainerV2CascadeFullRes_smallerBinStrel',
        #'',
        #'',
        #'',
        #'',
