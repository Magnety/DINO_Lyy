...
import numpy as np
from dino_frame.postprocessing.consolidate_postprocessing import collect_cv_niftis
...
def evaluate_regions(folder_predicted: str, folder_gt: str, regions: dict, processes=4):
