...
import numpy as np
from dino_frame.experiment_planning.experiment_planner_baseline_3DUNet_v21 import \
...
from dino_frame.network_architecture.generic_modular_residual_UNet import FabiansUNet
...
class ExperimentPlanner3DFabiansResUNet_v21(ExperimentPlanner3D_v21):
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        ...
        self.data_identifier = "tuData_plans_v2.1"# "simple_frameData_FabiansResUNet_v2.1"
        self.plans_fname =  self.preprocessed_output_folder+"/"+"tuPlans_FabiansResUNet_v2.1_plans_3D.pkl"
