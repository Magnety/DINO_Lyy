...
class ExperimentPlannerTargetSpacingForAnisoAxis(ExperimentPlanner):
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        ...
        self.data_identifier = "simple_frameData_targetSpacingForAnisoAxis"
        self.plans_fname = self.preprocessed_output_folder+"/"+ "simple_framePlans" + "targetSpacingForAnisoAxis_plans_3D.pkl"
