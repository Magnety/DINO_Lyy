...
from dino_frame.configuration import default_num_threads
from dino_frame.experiment_planning.DatasetAnalyzer import DatasetAnalyzer
from dino_frame.experiment_planning.common_utils import get_pool_and_conv_props_poolLateV2
from dino_frame.experiment_planning.utils import create_lists_from_splitted_dataset
from dino_frame.network_architecture.generic_UNet import Generic_UNet
from dino_frame.paths import *
from dino_frame.preprocessing.cropping import get_case_identifier_from_npz
...
class ExperimentPlanner(object):
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        ...
        self.plans_fname = self.preprocessed_output_folder+"/"+ "simple_framePlans" + "fixed_plans_3D.pkl"
    ...
    def plan_experiment(self):
        ...
        # thanks Zakiyi (https://github.com/MIC-DKFZ/simple_frame/issues/61) for spotting this bug :-)
    ...
    def run_preprocessing(self, num_threads):
        ...
        preprocessor_class = recursive_find_python_class([dino_frame.__path__[0] + "/" + "preprocessing"],
                                                         self.preprocessor_name, current_module="dino_frame.preprocessing")
