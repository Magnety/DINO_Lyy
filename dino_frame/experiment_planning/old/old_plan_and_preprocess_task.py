...
from dino_frame.experiment_planning.utils import split_4d, crop, analyze_dataset, plan_and_preprocess
from batchgenerators.utilities.file_and_folder_operations import *
from dino_frame.paths import simple_frame_raw_data
...
if __name__ == "__main__":
    ...
    if task == "all":
        all_tasks = subdirs(simple_frame_raw_data, prefix="Task", join=False)
        for t in all_tasks:
        ...
        if not use_splitted or not isdir(simple_frame_raw_data+"/"+ task):
