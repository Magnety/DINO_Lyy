...
def pretend_to_be_simple_frameTrainer(folder, checkpoints=("model_best.model.pkl", "model_final_checkpoint.model.pkl")):
    pretend_to_be_other_trainer(folder, "simple_frameTrainer", checkpoints)
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description='Use this script to change the dino_frame trainer class of a saved '
