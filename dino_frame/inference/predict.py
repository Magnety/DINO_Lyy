...
from dino_frame.inference.segmentation_export import save_segmentation_nifti_from_softmax, save_segmentation_nifti
...
from dino_frame.postprocessing.connected_components import load_remove_save, load_postprocessing
from dino_frame.training.model_restore import load_model_and_checkpoint_files
from dino_frame.training.network_training.tuTrainer import simple_frameTrainer
from dino_frame.utilities.one_hot_encoding import to_one_hot
...
def preprocess_multithreaded(trainer, list_of_lists, output_files, num_processes=2, segs_from_prev_stage=None):
    ...
    assert isinstance(trainer, simple_frameTrainer)
    q = Queue(1)
    processes = []
