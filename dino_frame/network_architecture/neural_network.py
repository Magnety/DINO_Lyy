...
from dino_frame.utilities.random_stuff import no_op
from dino_frame.utilities.to_torch import to_cuda, maybe_to_torch
...
class ClassficationNetwork(NeuralNetwork):
    def __init__(self):
        super(NeuralNetwork, self).__init__()
