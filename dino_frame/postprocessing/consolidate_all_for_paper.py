...
def get_commands(configurations, regular_trainer="simple_frameTrainerV2", cascade_trainer="simple_frameTrainerV2CascadeFullRes",
    ...
    for task in configurations:
        ...
        for m in models:
            ...
            folder = get_output_folder_name(m, task, trainer, plans, overwrite_training_output_dir="/datasets/datasets_fabian/results/dino_frame")
