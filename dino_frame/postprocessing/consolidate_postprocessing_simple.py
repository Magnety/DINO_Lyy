...
import argparse
from dino_frame.postprocessing.consolidate_postprocessing import consolidate_folds
...
def main():
    ...
    argparser.add_argument("-tr", type=str, required=False, default=None,
                           help="simple_frameTrainer class. Default: %s, unless 3d_cascade_fullres "
    ...
    if trainer is None:
        if model == "3d_cascade_fullres":
            trainer = "simple_frameTrainerV2CascadeFullRes"
        else:
            trainer = "simple_frameTrainerV2"
