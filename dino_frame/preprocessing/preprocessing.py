...
from dino_frame.preprocessing.cropping import get_case_identifier_from_npz, ImageCropper
...
class GenericPreprocessor(object):
    ...
    def connect_mask_box(self,image, for_which_classes, minimum__size=100):
        """
    ...
    def _run_internal(self, target_spacing, case_identifier, output_folder_stage, cropped_output_dir, force_separate_z,
        ...
        num_samples = 10000
        min_percent_coverage = 0.4 # at least 1% of the class voxels need to be selected, otherwise it may be too sparse
    ...
    def run(self, target_spacings, input_folder_with_cropped_npz, output_folder, data_identifier,
            num_threads=4, force_separate_z=None):
        """
