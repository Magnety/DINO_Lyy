...
from dino_frame.data_augmentation.data_augmentation import default_3D_augmentation_params, default_2D_augmentation_params, get_default_augmentation, get_patch_size
                ...
                if self.aug_more:
                    self.train_data, self.val_data = get_moreDA_augmentation(self.train_data, self.val_data,
                                                                             self.data_aug_params[
                                                                                 'patch_size_for_spatialtransform'],#[32,128,128]
                                                                             self.data_aug_params,
